...
class IntentANN:
    ...
    def _build_model(self):
        # Similar to Emotion ANN but tuned for Intent
        ...
        model = Model(inputs=input_layer, outputs=output_layer, name="Intent_ANN")
    ...
    def save(self, path='models/intent_ann.h5'):
        self.model.save(path)
    
    def load(self, path='models/intent_ann.h5'):
